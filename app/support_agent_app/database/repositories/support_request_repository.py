"""Postgres implementation of the support-request lifecycle with claim fencing.

The lifecycle vocabulary lives in `application/lifecycle.py`. This module owns
only the SQL, transaction boundaries, and row mapping that make it durable.
"""
...
class PostgresSupportRepository:
    ...
    def find_failed_reply_action(
        ...
        *,
        ...
        return self._find_reply_action(claim, ("failed",), timeout_seconds=timeout_seconds)
    ...
    def find_stranded_reply_action(
        ...
        *,
        ...
        return self._find_reply_action(
            claim,
            ("pending", "sending"),
            timeout_seconds=timeout_seconds,
        )
