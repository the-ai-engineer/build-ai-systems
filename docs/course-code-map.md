...
| Worker | `app/support_agent_app/worker/`, `app/support_agent_app/demos/run_worker.py` |
| Local queue and Slack ingress | `app/support_agent_app/api/`, `app/support_agent_app/demos/run_end_to_end.py` |
